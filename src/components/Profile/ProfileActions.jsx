...
const ProfileActions = () => {
  ...
  return (
    <ul className="profile-actions-list">
      <li className="profile-actions-list-item">
        <button className="profile-actions-button" onClick={handleClearHistory}>
          Clear history
        </button>
      </li>
      <li className="profile-actions-list-item">
        <button className="profile-actions-button" onClick={handleLogoutClick}>
          Logout
        </button>
      </li>
    </ul>
